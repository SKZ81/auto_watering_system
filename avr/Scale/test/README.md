...
* do a `platformio run && platformio run --target upload` in this directory (**NOTE** : optionnaly provide -e {uno,nodemcu,devkit-v4} to build for a specific target. PIO calls it "environment")
